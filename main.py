...
'''
# from core.body_entity import OutputBody


# class Module(Module):
#     def run(self, data) -> OutputBody:

#         return main(data.get("input"), data.get("setting"))
'''
if __name__ == "__main__":

    '''
        input_data: 测试用输入数据，负荷类型为热负荷峰值3500
    '''
    input_data = {
        "setting": {
            "ele_TOU_price": [
    ...
    def test_main(alpha):
        TEST_ALF = alpha    # ! 测试使用
        return main(input_data.get("input"), input_data.get("setting"))
    '''